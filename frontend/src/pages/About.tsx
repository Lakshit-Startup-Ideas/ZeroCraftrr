        ...
        <div className="space-y-10">
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
                <div className="flex flex-col gap-4">
                    <p className="text-sm font-semibold uppercase tracking-wide text-indigo-600">About ZeroCraftr</p>
                    <h1 className="text-3xl font-bold text-slate-900">We craft AI-led reliability for sustainable ops.</h1>
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2 text-sm">
                            <span className="rounded-full bg-white px-3 py-1 text-indigo-700">Telemetry APIs</span>
                            <span className="rounded-full bg-white px-3 py-1 text-indigo-700">AI overlays</span>
                            <span className="rounded-full bg-white px-3 py-1 text-indigo-700">Carbon insights</span>
                        </div>
                    </div>
